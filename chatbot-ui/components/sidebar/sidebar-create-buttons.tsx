...
export const SidebarCreateButtons: FC<SidebarCreateButtonsProps> = ({
  ...
  return (
    <div className="flex w-full space-x-2">
      <Button variant="ghost" className="flex h-[36px] grow" onClick={getCreateFunction()}>
      ...
      {hasData && (
        <Button variant="ghost" className="size-[36px] p-1" onClick={handleCreateFolder}>
      ...
      {isCreatingIntegration && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-background p-6 rounded-lg">
            ...
            <p>Integration creation coming soon!</p>
            <Button variant="ghost" onClick={() => setIsCreatingIntegration(false)}>Close</Button>
          </div>
        </div>
      )}
